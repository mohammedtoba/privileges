...
const bowervendors = 'resources/assets/vendors/';
...
const paths = {
    ...
    'datatables_responsive': vendors + 'datatables.net-responsive/',
...
mix.copy(paths.bootstrap_slider + 'bootstrap-slider.min.js',  destVendors + 'bootstrap-slider/js');

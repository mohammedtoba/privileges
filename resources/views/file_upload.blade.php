...
<script type="text/javascript" src="{{asset('assets/vendors/blueimp-tmpl/js/tmpl.js')}}"></script>
<script type="text/javascript" src="{{asset('assets/vendors/blueimploadimage/js/load-image.all.min.js')}}"></script>
<script type="text/javascript" src="{{asset('assets/vendors/blueimp-canvas-to-blob/js/canvas-to-blob.js')}}"></script>

...
<form action="{{route('saveTP')}}" method="post"    enctype="multipart/form-data">
	{{ csrf_field() }}
                                            ...
                                            <div class="row">
                                                <div class="col-12 px-0">
                                                    <ul id="editable" class="list-unstyled">
                                                        <li>group one<i class="fa fa-close"></i></li>
                                                        <li>group two<i class="fa fa-close"></i></li>
                                                        <li>group three<i class="fa fa-close"></i></li>
                                                    </ul>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            <button class="btn btn-warning" id="modal_close_btn" data-dismiss="modal">Close</button>
                                             <button class="btn btn-primary" id="modal_close_btn" data-dismiss="modal">Add group</button>
...
<script type="text/javascript" src="{{asset('assets/vendors/datatables/js/dataTables.scroller.min.js')}}"></script>
 <script type="text/javascript" src="{{asset('assets/vendors/sortable/js/Sortable.js')}}"></script>

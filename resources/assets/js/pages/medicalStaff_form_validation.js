    ...
    $('#form_block_validator').bootstrapValidator({
        fields: {
            ...
            qualif_year:{
                validators: {
                    notEmpty: {
                        message: 'Please provide graduation year.'
                    }
                    between: {
                        min: 1900,
            ...
            college:{
                validators: {
                    notEmpty: {
                        message: 'Please provide graduation college'
                    }
                }
            },
            qualif_univ:{
                validators: {
                    notEmpty: {
                        message: 'Please provide graduation university.'
                    }
                }
            },
            qualif_country:{
                validators: {
                    notEmpty: {
                        message: 'Please provide graduation country.'
                    }
                }
            },
            clg_email: {
                validators: {
                    ...
                    regexp: {
                        regexp: /^\S+@\S{1,}\.\S{1,}$/,
                        message: 'Thhis is not a valid email address.'
                    }
                }
            },
            Password2: {

...
<body class="login_backimg" style="background-color: black;">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-12">
                                    <label class="custom-control custom-radio">
                                        <input type="radio" name="usrtype" class="custom-control-input form-control"  value="M" {{old('usrtype') == "M"? 'active' : ''}}>
                                        <span class="custom-control-indicator"></span>
                                        <a class="custom-control-description">Yes</a>
                                    </label>
                                    <label class="custom-control custom-radio">
                                        <input type="radio" name="usrtype" class="custom-control-input form-control" value="B" {{old('usrtype') == 'B'? 'active' : ''}}>
                                        <span class="custom-control-indicator"></span>

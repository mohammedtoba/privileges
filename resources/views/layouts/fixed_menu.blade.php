        ...
        <nav class="navbar navbar-static-top">
            <div class="container-fluid m-0">
                <a class="navbar-brand mr-0" href="index">
                    <h4 class="text-white"><img src="{{asset('assets/img/logow.png')}}" class="admin_img" alt="logo"> SAFE PRACTICE</h4>
                </a>
                ...
                <div class="topnav dropdown-menu-right ml-auto">
                    ...
                    <div class="btn-group">
                        <div class="notifications messages no-bg">
                            <a class="btn btn-default btn-sm" id="markAsRead" data-toggle="dropdown"> <i class="fa fa-bell text-white"></i>
                                <span class="badge badge-danger">{{count(auth()->user()->unreadNotifications)}}</span>
                            </a>
                            <div class="dropdown-menu drop_box_align" role="menu">
                                <div class="popover-header">You have {{count(auth()->user()->unreadNotifications)}} Notifications</div>
                                <div id="notifications">
                                    @foreach(auth()->user()->notifications as $notification)
                                    <div class="data">
                                        <div class="row "{{$notification->read_at? '' : 'bg-warning'}}>
                                            <div class="col message-data {{$notification->read_at? 'disabled' : ''}}" >
                                                <!-- href="$notification->data['action']}}" -->
                                                <a href="#currentUsers" data-notif-id="{{$notification->id}}">
                                                    <strong>{{auth()->user($notification->data['id'])->name}}</strong> says {{$notification->data['content']}}
                                                    <br>
                                                    <small class="primary_txt">{{Carbon\Carbon::parse(($notification->created_at))->diffForHumans()}}</small>
                                                </a>
                                                <br>
                                            </div>
                                        </div>
        ...
        <div id="left" class="fixed">
            <div class="menu_scroll  left_scrolled">
                ...
                <ul id="menu" class="bg-blue dker">
                    ...
                    <li  {!! (Request::is('apply')|| Request::is('qual')|| Request::is('exper') || Request::is('train') || Request::is('licensure')? 'class="active"':"")!!}>
                    <a href="#">
                        <i class="fa fa-user-md"></i>
                        <span class="link-title menu_hide">&nbsp; Medical staff information</span>
                        <span class="fa arrow menu_hide"></span>
                    </a>
                    <ul>
                        <li {!! (Request::is('apply')? 'class="active"':"") !!}>
                        <a href="{{route('MSapply')}} ">
                            <i class="fa fa-angle-right"></i>
                            &nbsp; Personal information
                        </a>
                        </li>

                        <li {!! (Request::is('qual')? 'class="active"':"") !!}>
                        <a href="{{route('newQual')}}">
                            <i class="fa fa-angle-right"></i>
                            <span class="link-title">&nbsp; Education</span>

                        </a>
                        </li>
                        <li {!! (Request::is('exper')? 'class="active"':"") !!}>
                        <a href="{{route('Exper')}}">
                            <i class="fa fa-angle-right"></i>
                            &nbsp; Experience
                        </a>
                        </li>
                        <li {!! (Request::is('train')? 'class="active"':"") !!}>
                        <a href="{{route('Train')}}">
                            <i class="fa fa-angle-right"></i>
                            &nbsp; Training
                        </a>
                        </li>
                        <li {!! (Request::is('licensure')? 'class="active"':"") !!}>
                        <a href="#">
                            <i class="fa fa-angle-right"></i>
                            &nbsp; Licensure
                        </a>
                    ...
                    <li  {!! (Request::is('my_department')|| Request::is('department_requests')|| Request::is('statistics_entry')? 'class="active"':"")!!}>
                    <a href="#">
                        <i class="fa fa-tasks"></i>
                        <span class="link-title menu_hide">&nbsp; Department head domain</span>
                        <span class="fa arrow menu_hide"></span>
                    </a>
                    <ul>
                        <li {!! (Request::is('my_department')? 'class="active"':"") !!}>
                        <a href="#">
                            <i class="fa fa-angle-right"></i>
                            &nbsp; Department View
                        </a>
                        ...
                        <li {!! (Request::is('department_requests')? 'class="active"':"") !!}>
                        <a href="{{route('newQual')}}">
                            <i class="fa fa-angle-right"></i>
                            <span class="link-title">&nbsp; Department Requests</span>

                        </a>
                        </li>
                        <li {!! (Request::is('statistics_entry')? 'class="active"':"") !!}>
                        <a href="#">
                            <i class="fa fa-angle-right"></i>
                            &nbsp; Statistics Entry
                        </a>
                    ...
                    <li  {!! (Request::is('evaluate/list')|| Request::is('evaluate/history')? 'class="active"':"")!!}>
                    <a href="#">
                        <i class="fa fa-check"></i>
                        <span class="link-title menu_hide">&nbsp; Evaluate a medical staff</span>
                        <span class="fa arrow menu_hide"></span>
                    </a>
                    <ul>
                        <li {!! (Request::is('evaluate/list')? 'class="active"':"") !!}>
                        <a href="{{route('evalList')}} ">
                            <i class="fa fa-angle-right"></i>
                            &nbsp; List for evaluation
                        </a>
                        </li>

                        <li {!! (Request::is('evaluate/history')? 'class="active"':"") !!}>
                        <a href="{{route('evalHistory')}}">
                            <i class="fa fa-angle-right"></i>
                            <span class="link-title">&nbsp; Previous evaluations</span>

                        </a>
                        </li>
                    </ul>
                    </li>
                    <li  {!! (Request::is('controlPanel/users/view')|| Request::is('controlPanel/users/add')|| Request::is('department_setup')|| Request::is('statistics_entry')? 'class="active"':"")!!}>
                    <a href="#">
                        <i class="fa fa-gear"></i>
                        <span class="link-title menu_hide">&nbsp; Control Panel</span>
                        <span class="fa arrow menu_hide"></span>
                    </a>
                    <ul>
                        <li {!! (Request::is('controlPanel/users/view') || Request::is('controlPanel/users/add')? 'class="active"':"") !!}>
                        <a href="#">
                            <i class="fa fa-angle-right"></i>
                            &nbsp; Users grid
                        </a>
                            <ul class="sub-menu sub-submenu">
                                        <li {!! (Request::is('controlPanel/users/view#currentUsers')? 'class="active"':"") !!}>
                                            <a href="{{route('viewUsers')}}#currentUsers">
                                                <i class="fa fa-angle-right"></i>
                                                &nbsp;active users
                                            </a>
                                        </li>
                                        <li {!! (Request::is('controlPanel/users/view#deletedUsers')? 'class="active"':"") !!}>
                                            <a href="{{route('viewUsers')}}#deletedUsers">
                                                <i class="fa fa-angle-right"></i>
                                                &nbsp;Deleted users
                                            </a>
                                        </li>
                                        <li {!! (Request::is('controlPanel/users/add')? 'class="active"':"") !!}>
                        ...
                        <li {!! (Request::is('department_setup')? 'class="active"':"") !!}>
                        <a href="{{route('Dept')}}">
                            <i class="fa fa-angle-right"></i>
...
<script type="text/javascript" src="{{asset('assets/js/pages/notification.js')}}"></script>
